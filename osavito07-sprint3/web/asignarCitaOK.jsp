        ...
        <div id="container" class="container_24">
            ...
            <div id="mainmenug" class="grid_20">
                <ul>
                    ...
                    <li><a href='asignarCitaOK.jsp' id ='mainmenugcurrent'><span>Asignar cita</span></a></li>
                        ...
                        <div id="contentborde">
                            <div id="webcontentcol">
                                <div class="grid_19">
                                    ...
                                    <%
                                        String codCita = (String) session.getAttribute("codCita");
                                    %>
                                    
                                    Su cita se ha asignado correctamente. ID de la cita: <%= codCita%>
