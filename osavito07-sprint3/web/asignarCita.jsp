        ...
        <div id="container" class="container_24">
            ...
            <div id="mainmenug" class="grid_20">
                <ul>
                    ...
                    <li><a href='asignarCita.jsp' id ='mainmenugcurrent'><span>Asignar cita</span></a></li>
                                ...
                                <div class="grid_19">
                                    ...
                                    <form name="formDatos" id="formDatos" method="post" >
                                        ...
                                        <div class="grid_7">
                                            <p>Sanitario:
                                                <select name="tiposanitario" id="tiposanitario">
                                                    <option value="ME">Medico/a</option>  
                                                    <option value="EN">Enfermero/a</option>
                                                    <option value="MA">Matron/a</option>  
                                                </select>     
                                        </div>
                                        ...
                                        <div class="action_buttons center">
                                            <input id="btnalta" name="dardealta" value="Confirmar cita" class="btngo" type="submit"/>
                                            <input id="btlimpiar" name="limpiar" value="Limpiar" class="btngo" type="reset" />
                                            <input id="btnvolver" name="volver" value="Volver" class="btngo" type="button" onclick="location='asignarOCancelar.html'" />
                                        </div>
